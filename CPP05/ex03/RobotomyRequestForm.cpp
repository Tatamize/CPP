...
{
	colornote(MEMO, 3, "RobotomyRequestForm constructor called", "");
}

RobotomyRequestForm::~RobotomyRequestForm()
{
	colornote(MEMO, 3, "RobotomyRequestForm destructor called", "");
}
...
{
	*this = source;
	colornote(MEMO, 3, "RobotomyRequestForm copy constructor called", "");
}
