...
{
	colornote(3, "ShrubberyCreationForm constructor called", "");
}

ShrubberyCreationForm::~ShrubberyCreationForm()
{
	colornote(3, "ShrubberyCreationForm destructor called", "");
}
...
{
	*this = source;
	colornote(3, "ShrubberyCreationForm copy constructor called", "");
}
