...
Bureaucrat::Bureaucrat(std::string name, int grade): _name(name)
{
	...
	colornote( PRINT, 3, " Bureaucrat constructor called", _name);
}

Bureaucrat::~Bureaucrat()
{
	colornote( PRINT, 3, " Bureaucrat destructor called", _name);
}
...
{
	*this = source;
	colornote( PRINT, 3, " Bureaucrat copy constructor called", _name);
}
