...
{
	colornote( PRINT, 3, "PresidentialPardonForm constructor called", "");
}

PresidentialPardonForm::~PresidentialPardonForm()
{
	colornote( PRINT, 3, "PresidentialPardonForm destructor called", "");
}
...
{
	*this = source;
	colornote( PRINT, 3, "PresidentialPardonForm copy constructor called", "");
}
