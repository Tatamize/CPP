...
{
	colornote( PRINT, 3, "RobotomyRequestForm constructor called", "");
}

RobotomyRequestForm::~RobotomyRequestForm()
{
	colornote( PRINT, 3, "RobotomyRequestForm destructor called", "");
}
...
{
	*this = source;
	colornote( PRINT, 3, "RobotomyRequestForm copy constructor called", "");
}
